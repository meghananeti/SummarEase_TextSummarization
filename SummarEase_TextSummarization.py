...
def main():
    ...
    # Speech code for Streamlit
       ...
       # Set background image from URL
        background_image_url = "https://www.intelligentliving.co/wp-content/uploads/2019/11/mlvoice.jpg"
        background_style = f"""
            <style>
                .stApp {{
                    background-image: url('{background_image_url}');
    ...
    # Translate code for Streamlit 
        ...
        background_image_url = "https://www.translateplus.com/wp-content/uploads/2020/06/Artificial-Intelligence.png"
        background_style = f"""
            <style>
                .stApp {{
                    background-image: url('{background_image_url}');
